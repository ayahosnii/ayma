export const staticPrimaryColor = '#F25F29'
export const staticPrimaryDarkenColor = '#F23005'
export const themes = {
  light: {
    dark: false,
    colors: {
      ...
      'on-primary': '#fff',
      'primary-darken-1': '#F25F29',
      'secondary': '#8A8D93',
      'secondary-darken-1': '#7C7F84',
      'on-secondary': '#fff',
      'success': '#34BF65',
      'success-darken-1': '#2da156',
      'on-success': '#fff',
      'info': '#16B1FF',
      'info-darken-1': '#149FE6',
      'on-info': '#fff',
      'warning': '#FF9E3D',
      'warning-darken-1': '#E67C2F',
      'on-warning': '#fff',
      'error': '#FF4C4C',
